...
const tentPackages = [
  {
    ...
    descriptionHe:
      "17 מ״ר + גובה עמידה מלא 2.3 מ׳. שני חדרים נפרדים עם מחיצה נשלפת, 4 חלונות TPU פנורמיים, כיסוי גשם, רצפה נשלפת ומשאבה ידנית. בד TC 35% כותנה/65% פוליאסטר — נושם ועמיד.",
    specs: {
      area: "17.3 מ״ר",
      dimensions: "3.6 × 4.8 מ׳",
      height: "2.3 מ׳",
      capacity: "עד 8 אנשים",
      weight: "~72 ק״ג",
      setup: "~10 דקות",
  ...
  },
  {
    ...
    descriptionHe:
      "13.7 מ״ר עם גובה 2.7 מ׳ וחלון תקרה TPU עלה-בצורה לאור טבעי. דלת קדמית מפוצלת לפתיחה עצמאית, מערכת התנפחות מהירה 30% יותר, 2 חלונות TPU משושה וחיבור מודולרי לאוהלים נוספים.",
    specs: {
      area: "13.7 מ״ר",
  ...
  },
  {
    ...
    descriptionHe:
      "כיפה עגולה 5 מ׳ קוטר × 2.5 מ׳ גובה עם 5 חלונות TPU ו-5 דלתות שקופות. שטח 19.6 מ״ר, בד TC עם UPF 50+ ועמידות PU2000+. כיסוי גשם כסוף, 30 יתדות, 28 חבלי עיגון.",
    specs: {
      area: "19.6 מ״ר",
      dimensions: "ø5.0 מ׳",
      height: "2.5 מ׳",
  ...
  },
  {
    ...
    descriptionHe:
      "13.7 מ״ר, גובה 2.7 מ׳, 4-6 אנשים. מערכת חיבור 4-צדדית לאוהלים נוספים, חלון תקרה, 4 חלונות רשת ו-TPU. רצפה נשלפת, מותאם לכל עונה.",
    specs: {
      area: "13.7 מ״ר",
  ...
  },
  {
    ...
    descriptionHe:
      "17.2 מ״ר, גובה 2.2 מ׳ ל-4-6 אנשים. 4 חלונות TPU, 3 אפשרויות דלת (TPU / רשת / בד), כיסוי גשם PU, 22 יתדות, 20 חבלי רוח. בד TC נושם עמיד PU2000+.",
    specs: {
      area: "17.2 מ״ר",
      dimensions: "3.6 × 4.8 מ׳",
      height: "2.2 מ׳",
