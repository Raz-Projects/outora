...
const tentPackages = [
  ...
  },
  {
    ...
    descriptionHe:
      "13.3 מ״ר בתצורת Hub 3.6×3.6 מ׳ עם גובה פנים יוצא דופן 2.7 מ׳. 6 חלונות-גג TPU פנורמיים עם כיסויי קנבס, קירות אנכיים 1.9 מ׳, 2 כניסות, פתח למדח ויציאת חשמל. בד TC Canvas 210gsm ל-4 עונות.",
    specs: {
      area: "13.3 מ״ר",
  ...
  },
  {
    ...
    descriptionHe:
      "כיפה עגולה ⌀5.0 מ׳ × 2.45 מ׳ גובה — 20 מ״ר שטח פנימי עם 11 חלונות: 6 חלונות-גג TPU + 5 חלונות רשת-קנבס. 3 כניסות נפרדות, פתח למדח, רצפה נשלפת Oxford. בד TC Canvas 210gsm עמיד ל-4 עונות.",
    specs: {
      area: "20 מ״ר",
      dimensions: "⌀ 5.0 מ׳",
      height: "2.45 מ׳",
  ...
  },
  {
    ...
    descriptionHe:
      "11.5 מ״ר בתצורת Hub 3.6×3.6 מ׳ עם גובה פנים 2.75 מ׳. 4 חלונות-גג TPU עם כיסויי קנבס נגלגלים. עמיד −15°C עד 40°C. בד TC Canvas 210gsm, רצפה נשלפת Oxford. הכי קל להקמה — 5 דקות בלבד.",
    specs: {
      area: "11.5 מ״ר",
      dimensions: "3.6 × 3.6 מ׳",
      height: "2.75 מ׳",
  ...
  },
  {
    ...
    descriptionHe:
      "13.6 מ״ר בפריסה 3.8×3.6 מ׳, גובה מרכזי 2.2 מ׳. שני חדרים (1.82 + 1.98 מ׳), 2 חלונות-גג TPU + 4 חלונות רשת, 2 כניסות. רצפת PVC 550g/m² מבודדת. בד TC Canvas 210gsm — נושם ועמיד לארבע עונות.",
    specs: {
      area: "13.6 מ״ר",
