...
const tentPackages = [
  {
    ...
    descriptionHe:
      "17.2 מ״ר פנימיים בפריסה 4.8×3.6 מ׳ עם גובה עמידה מלא 2.3 מ׳. שני חדרים נפרדים (מחיצה נשלפת), 2 חלונות-גג TPU פנורמיים + 4 חלונות רשת, 2 כניסות, פתח למדח. בד TC Canvas 210gsm (65% פוליאסטר / 35% כותנה).",
    specs: {
      area: "17.2 מ״ר",
  ...
  },
  {
    ...
    descriptionHe:
      "13.7 מ״ר בתצורת Hub 3.8×3.6 מ׳ עם גובה פנים יוצא דופן 2.7 מ׳. 6 חלונות-גג TPU פנורמיים עם כיסויי קנבס, קירות אנכיים 1.9 מ׳, 2 כניסות, פתח למדח ויציאת חשמל. בד TC Canvas 210gsm ל-4 עונות.",
    specs: {
      area: "13.7 מ״ר",
  ...
  },
  {
    ...
    descriptionHe:
      "כיפה עגולה ⌀5.0 מ׳ × 2.7 מ׳ גובה — כ-20 מ״ר שטח פנימי עם 11 חלונות: 6 חלונות-גג TPU + 5 חלונות רשת-קנבס. 3 כניסות נפרדות, פתח למדח, רצפה נשלפת Oxford. בד TC Canvas 210gsm עמיד ל-4 עונות.",
    specs: {
      area: "~20 מ״ר",
      dimensions: "⌀ 5.0 מ׳",
      height: "2.7 מ׳",
  ...
  },
  {
    ...
    descriptionHe:
      "13 מ״ר בתצורת Hub 3.6×3.6 מ׳ עם גובה פנים 2.75 מ׳. 4 חלונות-גג TPU עם כיסויי קנבס נגלגלים. עמיד −15°C עד 40°C. בד TC Canvas 210gsm, רצפה נשלפת Oxford. הכי קל להקמה — 5 דקות בלבד.",
    specs: {
      area: "13 מ״ר",
  ...
  },
  {
    ...
    descriptionHe:
      "17.2 מ״ר בפריסה 4.8×3.6 מ׳, גובה מרכזי 2.2 מ׳ — אותו footprint של הFamilia PRO, רמת כניסה. חלונות TPU + רשת-קנבס, 2 כניסות, רצפה מבודדת לאורך כל החלל. בד TC Canvas 210gsm — נושם ועמיד לארבע עונות.",
    specs: {
      area: "17.2 מ״ר",
      dimensions: "4.8 × 3.6 מ׳",
      height: "2.2 מ׳",
