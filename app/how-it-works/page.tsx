...
const STEPS = [
  ...
  // ⚠️ במסמך השלב הוא "בוחרים רמת אירוח · BASIC, COMFORT או SIGNATURE". הרמות עוד לא באתר (ראו NOTES-FOR-OUTORA.md)
  {
    title: "בוחרים תוספות",
    desc: "תאורה, קפה, קירור, מקלחת, סינמה ועוד. מתחילים ממה שחייבים ומוסיפים רק מה שמתאים לחופשה שלכם.",
  },
  {
