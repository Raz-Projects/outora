      ...
      <section className="py-12 px-4 md:px-8">
        ...
        >
          ...
          <LegalSection title="4. מחירים ותשלום">
            <p>
              המחירים המפורסמים באתר הינם במטבע ישראלי (₪) וכוללים מע"מ לפי החוק. החברה רשאית לעדכן מחירים בכל עת; המחיר הקובע הוא זה שהיה בתוקף בעת ביצוע ההזמנה. התשלום מתבצע באמצעים המפורטים בדף ההזמנה.
            </p>
          </LegalSection>
          ...
          <LegalSection title="10. יצירת קשר">
            <p>
              לשאלות בנוגע לתקנון: <a href="mailto:Reservations@outora.co.il" style={{ color: "#C4954A" }}>Reservations@outora.co.il</a> או בווטסאפ:{" "}
