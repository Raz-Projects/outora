...
export type ExperiencePackage = {
  ...
  /** מזהי פריטים מ-lib/items.ts, לא טקסט חופשי */
  includes: string[]
  badge: PackageBadge
  image: string
  /** תמונות נוספות · מהמסד */
...
export const packages: ExperiencePackage[] = [
  {
    ...
    savingsPercent: 30,
    includes: ["fire-pit-large", "lounge-chairs", "camp-table-large", "garden-led", "welcome-booklet"],
    badge: "HOT",
    image: "/gallery/bonfire-beach.jpg",
    promoCode: "FRIENDS20",
    waText: "שלום! אני רוצה לבדוק זמינות לחבילת 'סופש חברים בפלמחים' · אוהל HAVEN PRIME, 2 לילות. מה הזמינות?",
    spotsLeft: 3,
  },
  {
    id: "romantic-dome",
    title: "ולנטיין HALO בכינרת",
    ...
    savingsPercent: 29,
    includes: ["arrival-flowers", "local-wine", "fairy-lights", "jute-rug", "scented-candles"],
    badge: "ROMANTIC",
    image: "/gallery/tent-to-beach-view.jpg",
    promoCode: "LOVE30",
    waText: "שלום! אני רוצה להזמין את חבילת הרומנטיקה · HALO בכינרת, 2 לילות. האם יש זמינות?",
  ...
  },
  {
    ...
    savingsPercent: 29,
    includes: ["small-telescope", "star-map", "warm-jacket", "morning-coffee", "walk-torch"],
    badge: "NEW",
    image: "/gallery/bonfire-closeup.jpg",
    promoCode: "STARS20",
    waText: "שלום! אני מתעניין בחבילת 'לילת כוכבים במדבר' · PAVILION במכתש רמון. מה הזמינות?",
    spotsLeft: 7,
  },
  {
    id: "family-north",
    ...
    savingsPercent: 26,
    includes: ["card-games", "bbq-kit", "kids-chairs", "big-table", "kids-night-light"],
    badge: "FAMILY",
  ...
  },
  {
    ...
    savingsPercent: 28,
    includes: ["custom-decor", "fire-pit-vip", "garden-lights-full", "bluetooth-music", "photographer"],
    badge: "VIP",
    image: "/gallery/interior-real-2.jpg",
    promoCode: "BDAY25",
    waText: "שלום! אני מחפש חבילת יום הולדת VIP · אוהל HAVEN PRIME, עד 17 איש. אפשר לשמוע מה יש?",
    spotsLeft: 2,
  },
  {
    id: "sea-mountains",
    ...
    savingsPercent: 27,
    includes: ["camp-kettle", "flashlight", "extra-blanket", "travel-books", "morning-coffee"],
    badge: "WEEKEND",
