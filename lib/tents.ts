...
export const tents: Tent[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  // HUB SHELTER PRO — COODY 13 Hub-Shelter PRO
  // 3.6m × 3.6m × 2.7m | 13.3 m² | up to 6 people | 59 kg total
  // ─────────────────────────────────────────────────────────────────────────
  {
  ...
  // 5m × 5m × 2.45m | ~20 m² | up to 6 people | 55 kg total
  // ─────────────────────────────────────────────────────────────────────────
  {
    slug: "dome",
    nameEn: "AURORA DOME",
    ...
    descriptionHe:
      "אוהל הכיפה של COODY — 5 מטר קוטר, 20 מ״ר שטח פנימי וגובה מרכזי של 2.45 מ׳. " +
  ...
  // ─────────────────────────────────────────────────────────────────────────
  // HUB STATION — COODY 13 Hub-Shelter (standard)
  // 3.6m × 3.6m × 2.75m | 11.5 m² | up to 6 people | 63 kg total
  // ─────────────────────────────────────────────────────────────────────────
  {
    slug: "hub-station",
    nameEn: "HUB STATION",
    ...
    descriptionHe:
      ...
      "11.5 מ״ר שטח נקי בפריסה מרובעת 3.6×3.6 מ׳ עם 4 חלונות-גג TPU ענקיים ורוכסנים נשלפים לוויסות אוויר ואור. " +
  ...
  // ─────────────────────────────────────────────────────────────────────────
  // FAMILIA — COODY 13.6 Familia
  // 3.8m × 3.6m × 2.2m | 13.6 m² | up to 8 people | 60 kg total
  // ─────────────────────────────────────────────────────────────────────────
  {
    slug: "familia",
    nameEn: "FAMILIA",
    ...
    descriptionHe:
      "הגרסה הקלאסית של הפמיליה — 13.6 מ״ר בפריסה מלבנית 3.8×3.6 מ׳, עם גובה מרכזי 2.2 מ׳ וקירות צד 1.35 מ׳. " +
      "שני חדרים בפריסה טבעית: חדר קדמי (1.82 מ׳) וחדר אחורי (1.98 מ׳) עם שתי כניסות נפרדות, " +
      "2 חלונות-גג TPU שקופים ו-4 חלונות רשת-קנבס לאוורור מלא. " +
      "בד TC קנבס 210gsm, קורות אוויר PVC ∅150 מ״מ — עמיד לארבע עונות. " +
      "אידיאלי למשפחה של 4-8, עם מספיק מקום לכולם להרגיש בבית — בכל נקודה בישראל.",
    capacity: 8,
    sizeSqm: 13.6,
    heightM: 2.2,
    setupMinutes: 7,
    ...
    features: [
      "13.6 מ״ר שטח פנימי",
      "גובה מרכזי 2.2 מ׳ (קירות 1.35 מ׳)",
      "2 חדרים טבעיים: 1.82 מ׳ + 1.98 מ׳",
      "2 חלונות-גג TPU שקופים",
      "4 חלונות רשת-קנבס לאוורור מלא",
      "2 כניסות נפרדות קדמית ואחורית",
      "רצפת PVC 550g/m² מבודדת",
      "עמידות גשם 1,000 מ״מ (3,000 עם גג גשם)",
      "בד קנבס TC ל-4 עונות",
